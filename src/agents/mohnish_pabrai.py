...
def mohnish_pabrai_agent(state: AgentState, agent_id: str = "mohnish_pabrai_agent"):
    ...
    for ticker in tickers:
        ...
        pabrai_analysis[ticker] = {
            ...
            "short_term_price": pabrai_output.short_term_price,
            "medium_term_price": pabrai_output.medium_term_price,
            "long_term_price": pabrai_output.long_term_price,
            "target_buy_price": pabrai_output.target_buy_price,
            "target_sell_price": pabrai_output.target_sell_price,
        }
