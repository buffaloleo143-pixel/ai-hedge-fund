...
| 指标 | 数值 | 数据来源期 | 评价 |
|------|------|-----------|------|
| 市盈率（P/E） | {value} | {2024年报} | {评价} |
| 营收增长率 | {value} | {2024年报YoY} | {评价} |
| 营收3年CAGR | {value} | {2022-2024} | {评价} |
| 净资产收益率（ROE） | {value} | {2024年报} | {评价} |
| 自由现金流收益率（FCF Yield） | {value} | {2024年报} | {评价} |
| ... | ... | ... | ... |
...
- 财务数据口径：以最新年报为基准数据源，季报数据作为增量补充和验证
  - 增长率指标（营收增长率、盈利增长率等）：优先使用年报同比 -> 季报同比 -> 衍生计算
  - 非增长率指标（ROE、利润率、D/E等）：优先使用最新年报值
  - 新增 CAGR 3年复合增长率作为补充参考指标
  - 数据已内置多级 fallback 机制，增长率字段填充率 80%+
